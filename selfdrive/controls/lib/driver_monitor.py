...
_AWARENESS_TIME = 3600.  # 60 minute limit without user touching steering wheels make the car enter a terminal status
_AWARENESS_PRE_TIME_TILL_TERMINAL = 10.  # a first alert is issued 10s before expiration
...
MAX_TERMINAL_ALERTS = 20      # not allowed to engage after 20 terminal alerts
